...
"gorm.io/gorm"
"portal-budaya-kalteng/internal/handlers"
...
admin := r.Group("/api/admin", middleware.BasicAuth(middleware.BasicConfig{ Username: basicUser, Password: basicPass }))
{
...
jwt := r.Group("/api/me", middleware.JWTAuth(middleware.JWTConfig{ Secret: jwtSecret }))
{
